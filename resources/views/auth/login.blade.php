...
<html
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset("../resources/assets/AdminLTE/iCheck/square/blue.css") }}">
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><b>SPIMS</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form role="form" method="POST" action="{{ url('/login') }}">
          ...
          <div class="form-group has-feedback {{ $errors->has('email') ? ' has-error' : '' }}">
            <input type="email" class="form-control" placeholder="Email or Radio ID">
    ...
    <!-- iCheck -->
    <script src="{{ asset("../resources/assets/AdminLTE/plugins/iCheck/icheck.min.js") }}"></script>
    <script>
      $(function () {
        $('input').iCheck({
